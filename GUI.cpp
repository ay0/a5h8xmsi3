...
void CGUI::Update()
{
	...
	for (auto window : Windows)
	{
		if (window->m_bIsOpen)
		{
			...
			Render::Text((centerW * 2) - 50, 25, Color(0, 120, 250, (MenuAlpha - 1)), Render::Fonts::ESP, "crownd.cc");
			Render::Text((centerW * 2) - 50,25, Color(255, 10, 165, MenuAlpha), Render::Fonts::ESP, "cro");
