		...
		if (Interfaces::Engine->IsInGame() && Interfaces::Engine->IsConnected())
		{
			...
			if (Options::Menu.MiscTab.ClanTag.GetIndex() == 1)
			{
				...
				if (GetTickCount() > lastTime)
				{
					...
					switch (value) { 
					case 0:SetClanTag("[+ crownd.cc+]", "[crownd.cc beta 1.4 recode]"); break;
					case 1:SetClanTag("[+ crownd.cc-]", "[crownd.cc beta 1.4 recode]"); break;
					case 2:SetClanTag("[- crownd.cc-]", "[crownd.cc beta 1.4 recode]"); break;
					case 3:SetClanTag("[- crownd.cc+]", "[crownd.cc beta 1.4 recode]"); break;
					case 4:SetClanTag("[+ crownd.cc+]", "[crownd.cc beta 1.4 recode]"); break;
					case 5:SetClanTag("[- crownd.cc-]", "[crownd.cc beta 1.4 recode]"); break;
					case 6:SetClanTag("[- crownd.cc+]", "[crownd.cc beta 1.4 recode]"); break;
					}
			...
			else if (Options::Menu.MiscTab.ClanTag.GetIndex() == 2)
			{
				...
				if (GetTickCount() > lastTime)
				{
					...
					case 5:SetClanTag("   crownd.cc	", "crownd.cc beta 1.4 recode"); break;
					case 6:SetClanTag("  crownd.cc	", "crownd.cc beta 1.4 recode"); break;
					case 7:SetClanTag(" crownd.cc	", "crownd.cc beta 1.4 recode"); break;
					case 8:SetClanTag("crownd.cc	", "crownd.cc beta 1.4 recode"); break;
					case 9:SetClanTag("rownd.cc		", "crownd.cc beta 1.4 recode"); break;
					case 10:SetClanTag("ownd.cc		", "crownd.cc beta 1.4 recode"); break;
					case 11:SetClanTag("wnd.cc		", "crownd.cc beta 1.4 recode"); break;
					case 12:SetClanTag("nd.cc		", "crownd.cc beta 1.4 recode"); break;
					case 13:SetClanTag("d.cc		", "crownd.cc beta 1.4 recode"); break;
					case 14:SetClanTag(".cc			", "crownd.cc beta 1.4 recode"); break;
					case 15:SetClanTag("cc			", "crownd.cc beta 1.4 recode"); break;
					case 16:SetClanTag("c			", "crownd.cc beta 1.4 recode"); break;
			...
			else if (Options::Menu.MiscTab.ClanTag.GetIndex() == 4)
			{
				...
				switch (value)
				{
				case 0:SetClanTag("-INTERWEBZ", "crownd.cc beta 1.4 recode"); break;
			...
			else if (Options::Menu.MiscTab.ClanTag.GetIndex() == 5)
			{
				...
				switch (value) { //mirror.tk
				case 0:SetClanTag("->", "Mirror  beta 1.4 recode"); break;
				case 1:SetClanTag("->C", "Mirror  beta 1.4 recode"); break;
				case 2:SetClanTag("->Ca", "Mirror  beta 1.4 recode"); break;
				case 3:SetClanTag("->Cat", "Mirror  beta 1.4 recode"); break;
				case 4:SetClanTag("->Ca", "Mirror  beta 1.4 recode"); break;
				case 5:SetClanTag("->C", "Mirror  beta 1.4 recode"); break;
				case 6:SetClanTag("->", "Mirror  beta 1.4 recode"); break;
				case 7:SetClanTag("->H", "Mirror  beta 1.4 recode"); break;
				case 8:SetClanTag("->Ha", "Mirror  beta 1.4 recode"); break;
				case 9:SetClanTag("->Hac", "Mirror  beta 1.4 recode"); break;
				case 10:SetClanTag("->Hack", "Mirror  beta 1.4 recode"); break;
				case 11:SetClanTag("->Hac", "Mirror  beta 1.4 recode"); break;
				case 12:SetClanTag("->Ha", "Mirror  beta 1.4 recode"); break;
				case 13:SetClanTag("->H", "Mirror  beta 1.4 recode"); break;
			...
			else if (Options::Menu.MiscTab.ClanTag.GetIndex() == 6)
			{
				...
				switch (value) { //mirror.tk
				case 0:SetClanTag("Emily AA", "Mirror  beta 1.4 recode"); break;
		...
		if (Interfaces::Engine->IsConnected() && Interfaces::Engine->IsInGame() && pLocal->IsAlive())
		{
			...
			if (Options::Menu.VisualsTab.LBYIndicator.GetState())
			{
				...
				if (Interfaces::Engine->IsConnected() && Interfaces::Engine->IsInGame() && pLocal->IsAlive())
				{
					...
					{
						Render::Text(20, scrn.bottom - 150, Color(255, 0, 30, 255), Render::Fonts::LBY, "LBY");
					}
					else //0, 250, 80, 255
					{
						if (pCmd->viewangles.y - *pLocal->GetLowerBodyYawTarget() > 120)
						{
							Render::Text(20, scrn.bottom - 150, Color(0, 250, 80, 255), Render::Fonts::LBY, "LBY");

						}
						else
						{
							Render::Text(20, scrn.bottom - 150, Color(255, 160, 122, 255), Render::Fonts::LBY, "LBY");
			...
			if (Options::Menu.VisualsTab.manualaa.GetState())
			{
				if (bigboi::indicator == 1)
				{
					...
					Render::Text(centerW - 20, centerh - 40, Color(200, 200, 200, 250), Render::Fonts::jew, "-->");
					
				}
				else if (bigboi::indicator == 2)
				{
					Render::Text(centerW - 14, centerh - 40, Color(200, 200, 200, 250), Render::Fonts::jew, "<--");
				...
				else if (bigboi::indicator == 4)
				{
					...
					Render::Text(centerW - 40, centerh - 40, Color(200, 200, 200, 200), Render::Fonts::jew, "");
				}
			}
...
//							Render::Text(9, (centerh - 80), Color(250, 250, 250, 255), Render::Fonts::gay, jew);


//							sprintf_s(bufferlineRealAngle, "Real: %.1f", lineRealAngle);
//							Render::Text(9, (centerh - 70), Color(250, 250, 250, 255), Render::Fonts::gay, bufferlineRealAngle);


//							sprintf_s(bufferlineFakeAngle, "Fake: %.1f", lineFakeAngle);
//							Render::Text(9, (centerh - 60), Color(250, 250, 250, 255), Render::Fonts::gay, bufferlineFakeAngle);


//							sprintf_s(bufferLineLBY, "Lby: %.1f", lineLBY);
//							Render::Text(9, (centerh - 50), Color(250, 250, 250, 255), Render::Fonts::gay, bufferLineLBY);


//							sprintf_s(eh, "Speed:  %.1f", lspeed);
//							Render::Text(9, (centerh - 30), Color(250, 250, 250, 255), Render::Fonts::gay, eh);

//							Render::Text(9, (centerh + 30), Color(0, 250, 25, 255), Render::Fonts::gay, "OnGround: True");
//							Render::Text(9, (centerh + 30), Color(250, 250, 250, 255), Render::Fonts::gay, "OnGround:");

//							sprintf_s(trans, "FakeLag:  %.1f", blob);
//							Render::Text(9, (centerh + 20), Color(250, 250, 250, 255), Render::Fonts::gay, trans);

							sprintf_s(innac, "Innacuracy:  %.1f", inaccuracy);
							Render::Text(9, (centerW - 34, centerh + 10), Color(250, 250, 250, 255), Render::Fonts::gay, innac);
						}
						else
						{
//							sprintf_s(jew, "Pitch: %.1f", pitchmeme);
...
//							Render::Text(9, (centerh + 30), Color(250, 0, 25, 255), Render::Fonts::gay, "OnGround: False");
//							Render::Text(9, (centerh + 30), Color(250, 250, 250, 255), Render::Fonts::gay, "OnGround:");
