...
void Render::Initialise()
{
	...
	Fonts::ESPInfo = Interfaces::Surface->FontCreate();
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::ESP, "Verdona", 11, 400, 0, 0, FONTFLAG_NONE | FONTFLAG_DROPSHADOW | FONTFLAG_OUTLINE);
	Interfaces::Surface->SetFontGlyphSet(Fonts::ESPInfo, "Visitor TT2 (BRK)", 10, 410, 0, 0, FONTFLAG_DROPSHADOW | FONTFLAG_OUTLINE); // ADDED FOR WEAPON ESP WHICH IS COMMING SOON
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuText, "Verdana", 14, 370, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuTabs, "MyScriptFont", 18, 600, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::Slider, "Impact", 17, 600, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	Interfaces::Surface->SetFontGlyphSet(Fonts::Clock, "Verdana", 22, 600, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	Interfaces::Surface->SetFontGlyphSet(Fonts::Tabs, "badcache", 30, 600, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::LBY, "Impact", 38, 840, 0, 0, FONTFLAG_ANTIALIAS);
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::LBYIndicator, "Impact", 20, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::WeaponIcon, "Visitor TT2 (BRK)", 10, 500, 0, 0, FONTFLAG_NONE | FONTFLAG_OUTLINE);
