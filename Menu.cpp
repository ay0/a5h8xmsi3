...
#pragma region Options
	...
	OptionsHealth.AddItem("Text (beta)");
...
//	OptionsWeapone.SetFileId("opt_weapon");
//	OptionsGroup.PlaceCheckBox("Weapon", this, &OptionsWeapone);
	...
	OptionsGroup.PlaceLabledControl(1, "Meme ", this, &fakemedia);
...
#pragma endregion Setting up the Options controls
	...
	ChamsGroup.PlaceLabledControl(0, "Restrict To Enemy Team", this, &ChamsEnemyOnly); 
...
//	worldgroup.PlaceLabledControl(0, "Refresh Sky", this, &customskies2);
	...
	worldgroup.PlaceLabledControl(0, "Apply changes", this, &colmodupdate);
...
#pragma region Other
	...
	AntiAimGroup.AddTab(CGroupTab("AA builder", 2));
	AntiAimGroup.AddTab(CGroupTab("AA builder 2", 3));
	AntiAimGroup.AddTab(CGroupTab("AA Misc", 4));
